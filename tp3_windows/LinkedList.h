...
int ll_deleteLinkedList(LinkedList* this);//es el free libero lista dinamica solo usar si cree una linked la use y sali de la fun y perdi la referencia  de ella o sea si ya perdi acceso la  libero no se puede usar mas
